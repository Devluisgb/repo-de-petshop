...
if (!empty($_GET['id'])) {
    ...
    // Realiza una consulta para actualizar el estado del usuario a 0 (eliminación lógica) en la base de datos.
    $query_delete = mysqli_query($conexion, "UPDATE usuario SET estado = 0 WHERE idusuario = $id");

    // Cierra la conexión a la base de datos.
    mysqli_close($conexion);

    // Redirige al usuario a la página "usuarios.php" después de realizar la eliminación.
